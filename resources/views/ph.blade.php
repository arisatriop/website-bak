    ...
    <div class="m-main-content">
        ...
        <ul class="nav justify-content-center mt-5" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link active text-center" id="ph-tab" data-toggle="tab" href="#ph" role="tab" aria-controls="ph" aria-selected="true"><i class="fas fa-crown fa-3x"></i><br><p class="mt-1">PH</p></a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link text-center" id="audit-tab" data-toggle="tab" href="#audit" role="tab" aria-controls="audit" aria-selected="false"><i class="fas fa-balance-scale fa-3x"></i><br><p class="mt-1">Audit</p></a>
            </li>
            <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="ph" role="tabpanel" aria-labelledby="ph-tab">
                <div class="container">
                ...
                <h3 class="text-center mt-50 mb-5">ANGGOTA</h3>
                <!-- Testimony -->
                        ...
                        <div class="row ftco-animate justify-content-center">
                            <div class="col-md-12">
                                <div class="carousel-testimony owl-carousel">
                                    ...
                                    <div class="item">
                                        <div class="testimony-wrap d-flex">
                                            <div class="user-img" style="background-image: url({{ asset('/uploads/staff_images/' . $phs->image) }})">
                                            </div>
                                            <div class="text pl-4">
                                                <span class="quote d-flex align-items-center justify-content-center">
                                                    <i class="fas fa-quote-left fa-2x"></i>
                                                </span>
                                                <p class="text-justify t-text">{{$phs->quote}}</p>
                                                <p class="name">{{$phs->name}}</p>
                                                <span class="position">{{$phs->position}}</span>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                        ...
                        <div class="row ftco-animate justify-content-center">
                            <div class="col-md-12">
                                <div class="carousel-testimony owl-carousel">
                                    ...
                                    @foreach ($audits as $as)
                                    <div class="item">
                                        <div class="testimony-wrap d-flex">
                                            <div class="user-img" style="background-image: url({{ asset('/uploads/staff_images/' . $as->image) }})">
                                            </div>
                                            <div class="text pl-4">
                                                <span class="quote d-flex align-items-center justify-content-center">
                                                    <i class="fas fa-quote-left fa-2x"></i>
                                                </span>
                                                <p class="text-justify t-text">{{$as->quote}}</p>
                                                <p class="name">{{$as->name}}</p>
                                                <span class="position">{{$as->position}}</span>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                        ...
                        <div class="row ftco-animate justify-content-center">
                            <div class="col-md-12">
                                <div class="carousel-testimony owl-carousel">
                                    ...
                                    @foreach ($psdms as $psd)
                                    <div class="item">
                                        <div class="testimony-wrap d-flex">
                                            <div class="user-img" style="background-image: url({{ asset('/uploads/staff_images/' . $psd->image) }})">
                                            </div>
                                            <div class="text pl-4">
                                                <span class="quote d-flex align-items-center justify-content-center">
                                                    <i class="fas fa-quote-left fa-2x"></i>
                                                </span>
                                                <p class="text-justify t-text">{{$psd->quote}}</p>
                                                <p class="name">{{$psd->name}}</p>
                                                <span class="position">{{$psd->position}}</span>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                        ...
                        <div class="row ftco-animate justify-content-center">
                            <div class="col-md-12">
                                <div class="carousel-testimony owl-carousel">
                                    ...
                                    @foreach ($litbangs as $lits)
                                    <div class="item">
                                        <div class="testimony-wrap d-flex">
                                            <div class="user-img" style="background-image: url({{ asset('/uploads/staff_images/' . $lits->image) }})">
                                            </div>
                                            <div class="text pl-4">
                                                <span class="quote d-flex align-items-center justify-content-center">
                                                    <i class="fas fa-quote-left fa-2x"></i>
                                                </span>
                                                <p class="text-justify t-text">{{$lits->quote}}</p>
                                                <p class="name">{{$lits->name}}</p>
                                                <span class="position">{{$lits->position}}</span>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
