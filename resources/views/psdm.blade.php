...
@section('title', 'BAK - Profile PSDM')
...
<div class="m-main-content">
    ...
    <ul class="nav justify-content-center mt-5" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link active text-center" id="psdm-tab" data-toggle="tab" href="#psdm" role="tab" aria-controls="psdm" aria-selected="false"><i class="fas fa-child fa-3x"></i><br><p class="mt-1">Psdm</p></a>
        </li>
        <li class="nav-item" role="presentation">
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="psdm" role="tabpanel" aria-labelledby="psdm-tab">
            <div class="container">
