...
@section('title', 'BAK - Admin | PSDM')

@section('page-title','Divisi Pengembangan Sumber Daya Mahasiswa')
...
@section('content') 
    ...
    <div class="jumbotron m-5 bg-white shadow-lg">
            ...
            <div class="modal fade" id="modalEdit" tabindex="-1" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="/admin-psdm/update-photo/3" method="POST" enctype="multipart/form-data">
                            @csrf
        ...
        <ul class="nav justify-content-center mt-3">
            ...
            <li class="nav-item mx-1 mb-3">
                <div class="card" style="width: 14rem;">
                    ...
                    <!-- Modal Update-->
                    <form action="/admin-psdm/update/{{$p->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <!-- Modal Delete-->
                    <form action="/admin-psdm/delete/{{$p->id}}">
        ...
        <!-- Modal Add Person-->
        <form action="/admin-psdm/add-person" method="POST" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="modal-body">
                                ...
                                <label for="disabledSelect">Divisi</label>
                                    <select id="disabledSelect" class="form-control" disabled>
                                        <option>Divisi Pengembangan Sumberdaya Mahasiswa</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1">Quote</label>
