...
@section('title', 'BAK - Admin | Audit')

@section('page-title','Divisi Audit')
...
@section('content') 
    ...
    <div class="jumbotron m-5 bg-white shadow-lg">
        ...
        <ul class="nav justify-content-center mt-3">
            ...
            <li class="nav-item mx-1 mb-3">
                <div class="card" style="width: 14rem;">
                    ...
                    <!-- Modal Update-->
                    <form action="/admin-audit/update/{{$p->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <!-- Modal Delete-->
                    <form action="/admin-audit/delete/{{$p->id}}">
        ...
        <!-- Modal Add Person-->
        <form action="/admin-audit/add-person" method="POST" enctype="multipart/form-data">
            @csrf
