...
@section('title', 'BAK - Admin | PH')

@section('page-title','Pengurus Harian')
...
@section('content') 
    ...
    <div class="jumbotron m-5 bg-white shadow-lg">
            ...
            <div class="modal fade" id="modalEdit" tabindex="-1" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="/admin-ph/update-photo/1" method="POST" enctype="multipart/form-data">
                            @csrf
        ...
        <ul class="nav justify-content-center mt-3">
            ...
            <li class="nav-item mx-1 mb-3">
                <div class="card" style="width: 14rem;">
                    ...
                    <!--<a class="btn btn-secondary btn-sm" style="width: 40%" href="#" role="button" onclick="return confirm('Anda menghapus data: {{$p->name}}?')">Delete</a>  -->                      
                    ...
                    <!-- Modal Update-->
                    <form action="/admin-ph/update/{{$p->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <!-- Modal Delete-->
                    <form action="/admin-ph/delete/{{$p->id}}">
        ...
        <!-- Modal Add Person-->
        <form action="/admin-ph/add-person" method="POST" enctype="multipart/form-data">
            @csrf
