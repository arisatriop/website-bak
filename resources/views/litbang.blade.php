...
@section('title', 'BAK - Profile Litbang')
...
<div class="m-main-content">
    ...
    <ul class="nav justify-content-center mt-5" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link active text-center" id="litbang-tab" data-toggle="tab" href="#litbang" role="tab" aria-controls="litbang" aria-selected="false"><i class="fas fa-pen-alt fa-3x"></i><br><p class="mt-1">Litbang</p></a>
        </li>
    </ul>
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade  show active" id="litbang" role="tabpanel" aria-labelledby="litbang-tab">
            <div class="container">
